...
# %% auto 0
__all__ = ['SemanticColorValue', 'SemanticColor', 'is_valid_semantic_color', 'ColoredUtilityDaisyUI', 'ColoredFactoryDaisyUI',
           ...
           'get_brand_colors', 'get_base_colors', 'get_status_colors', 'test_colors_factory_documentation']
...
def test_colors_factory_documentation():
    ...
    assert bg_dui.describe() == "Background color utilities for daisyUI semantic colors"
    assert text_dui.describe() == "Text color utilities for daisyUI semantic colors"
    
    # Test get_info method
    info = bg_dui.get_info()
    assert info['description'] == "Background color utilities for daisyUI semantic colors"
