...
# %% auto 0
__all__ = ['DAISYUI_CDN', 'DAISYUI_THEMES_CDN', 'DAISYUI_COLOR_PROPERTIES', 'DAISYUI_COLOR_PROPERTIES_EXT', 'TAILWIND_CDN',
           'get_daisyui_headers', 'create_css_link', 'create_js_script', 'build_headers']
