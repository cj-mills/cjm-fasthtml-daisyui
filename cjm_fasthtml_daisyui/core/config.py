...
# %% auto 0
__all__ = ['DaisyUITheme', 'ThemeConfig', 'ExcludeFeature', 'DaisyUIConfig', 'ConfigPresets', 'ColorScheme', 'ThemeDesignTokens',
           'CustomTheme', 'ConfigManager']
...
class ConfigPresets:
    ...
    def minimal(
        ...
        return DaisyUIConfig(
            themes=[ThemeConfig(DaisyUITheme.LIGHT, is_default=True)]
        )
    ...
    def all_themes(
        ...
        all_themes = [theme for theme in DaisyUITheme]
        # Set light as default and dark as prefers-dark
        config = DaisyUIConfig(themes=[])
        
        for i, theme in enumerate(all_themes):
            is_default = theme == DaisyUITheme.LIGHT
            is_prefers_dark = theme == DaisyUITheme.DARK
            config.add_theme(theme, is_default, is_prefers_dark)
    ...
    def corporate(
        ...
        return DaisyUIConfig(
            themes=[
                ThemeConfig(DaisyUITheme.CORPORATE, is_default=True),
                ThemeConfig(DaisyUITheme.BUSINESS, is_prefers_dark=True),
                DaisyUITheme.LIGHT,
                DaisyUITheme.DARK
            ]
        )
    ...
    def creative(
        ...
        return DaisyUIConfig(
            themes=[
                ThemeConfig(DaisyUITheme.CUPCAKE, is_default=True),
                ThemeConfig(DaisyUITheme.SYNTHWAVE, is_prefers_dark=True),
                DaisyUITheme.CYBERPUNK,
                DaisyUITheme.VALENTINE,
                DaisyUITheme.RETRO
            ]
        )
    ...
    def accessible(
        ...
        return DaisyUIConfig(
            themes=[
                ThemeConfig(DaisyUITheme.LIGHT, is_default=True),
                ThemeConfig(DaisyUITheme.BLACK, is_prefers_dark=True),
                DaisyUITheme.WIREFRAME
            ]
        )
    ...
    def prefixed(
        ...
        return DaisyUIConfig(prefix=prefix)
