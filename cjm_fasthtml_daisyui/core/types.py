"""Protocols, enums, and utilities for type-safe daisyUI component development"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/core/types.ipynb.

# %% auto 0
__all__ = ['CSSContributor', 'FeatureSupport', 'ComponentProtocol', 'ColorSchemeType', 'DirectionType', 'PlacementType',
           'HTTPMethod', 'BrandType', 'StateType', 'CommonSizeType', 'BaseColor', 'BinaryType', 'DaisyComponentType',
           'DaisyPosition', 'DaisyBreakpoint', 'DaisySize', 'Direction', 'SemanticColor', 'ColorUtility',
           'OpacityLevel', 'StyleType', 'HTMXTrigger', 'HTMXSwap', 'DaisyUITheme', 'ExcludeFeature', 'CDNProvider',
...
class BaseColor(IntEnum):
    ...
    BASE_100 = 100 # Base surface color of page, used for blank backgrounds
    BASE_200 = 200 # Base color, darker shade, to create elevations
    BASE_300 = 300 # Base color, even more darker shade, to create elevations
