...
# %% auto 0
__all__ = ['btn', 'btn_colors', 'btn_styles', 'btn_sizes', 'btn_modifiers', 'btn_behaviors', 'test_button_basic_examples',
           'test_button_colors_examples', 'test_button_styles_examples', 'test_button_sizes_examples',
           'test_button_modifiers_examples', 'test_button_behaviors_examples', 'test_button_basic_fasthtml_examples',
           'test_button_sizes_fasthtml_examples', 'test_button_colors_variants_fasthtml_examples',
           'test_button_states_fasthtml_examples', 'test_button_shapes_fasthtml_examples',
...
btn_styles = SimpleFactory(
    ...
    "Button style variants (outline, dash, soft, ghost, link)"
) # Button style variants

# %% ../../../nbs/components/actions/button.ipynb 11
btn_sizes = SimpleFactory(
    {
        "xs": "btn-xs",
        "sm": "btn-sm",
        "md": "btn-md",
    ...
    "Button size variants from extra small to extra large"
