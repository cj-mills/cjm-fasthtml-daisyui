...
<form enctype="multipart/form-data"><select required class="select validator"><option disabled selected value="">Choose:</option><option>Tabs</option><option>Spaces</option></select>    <p class="validator-hint">Required</p>
